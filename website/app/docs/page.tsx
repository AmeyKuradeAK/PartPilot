  ...
  return (
    <div style={{ backgroundColor: 'var(--bg-primary)' }}>
      ...
      <section style={{ maxWidth: '1400px', margin: '0 auto', borderLeft: '1px solid var(--border-light)', borderRight: '1px solid var(--border-light)' }}>
        <div className="docs-grid" style={{ display: 'grid', gridTemplateColumns: '300px 1fr' }}>
          
          {/* Sidebar */}
          <div className="docs-sidebar" style={{ borderRight: '1px solid var(--border-light)', padding: '3rem 2rem', display: 'flex', flexDirection: 'column', gap: '1rem', position: 'sticky', top: '70px', height: 'calc(100vh - 70px)', overflowY: 'auto' }}>
          ...
          {/* Main Content */}
          <div className="docs-content" style={{ padding: '4rem 5rem', display: 'flex', flexDirection: 'column', gap: '6rem' }}>
            
            <div id="upload" className="docs-block" style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            <div id="confirm" className="docs-block" style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
             ...
             <div id="results" className="docs-block" style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
