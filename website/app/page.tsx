    ...
    <>
      ...
      <section className="section-pad" style={{
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '2rem' }}>
          ...
          <h1 className="hero-title" style={{ fontSize: '5.5rem', fontWeight: 800, letterSpacing: '-0.04em', lineHeight: 1, maxWidth: '900px', margin: 0, color: 'var(--text-primary)' }}>
            Global Hardware Procurement Network.
          </h1>
          
          <p className="hero-lead" style={{ fontSize: '1.25rem', color: 'var(--text-secondary)', maxWidth: '650px', lineHeight: 1.6, marginTop: '1rem' }}>
      ...
      <section style={{ backgroundColor: 'var(--bg-primary)' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto', borderLeft: '1px solid var(--border-light)', borderRight: '1px solid var(--border-light)' }}>
          ...
          <div className="section-pad" style={{ padding: '4rem 2rem', borderBottom: '1px solid var(--border-light)' }}>
      ...
      <section style={{ backgroundColor: 'var(--bg-elevated)', borderTop: '1px solid var(--border-light)', borderBottom: '1px solid var(--border-light)' }}>
        <div className="terminal-grid" style={{ maxWidth: '1400px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) 1fr' }}>
          
          <div className="terminal-left" style={{ padding: '6rem 4rem', borderRight: '1px solid var(--border-light)' }}>
            ...
            <ul className="terminal-list" style={{ borderTop: '1px solid var(--border-light)', paddingTop: '2rem', display: 'grid', gap: '1rem', color: 'var(--text-secondary)' }}>
          ...
          <div className="terminal-right" style={{ padding: '4rem' }}>
      ...
      <section className="section-pad" style={{ padding: '8rem 2rem', backgroundColor: 'var(--bg-primary)' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
          <h2 className="cta-title" style={{ fontSize: '3rem', fontWeight: 700, letterSpacing: '-0.02em', margin: 0, color: 'var(--text-primary)' }}>Initiate Procurement</h2>
