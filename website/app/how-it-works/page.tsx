  ...
  return (
    <div style={{ backgroundColor: 'var(--bg-primary)' }}>
      ...
      <section style={{ maxWidth: '1400px', margin: '0 auto', borderLeft: '1px solid var(--border-light)', borderRight: '1px solid var(--border-light)' }}>
        ...
        {/* Stage 1 */}
        <div className="stage-row" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', borderBottom: '1px solid var(--border-light)' }}>
          <div className="stage-cell" style={{ padding: '4rem', borderRight: '1px solid var(--border-light)' }}>
          ...
          <div className="stage-cell" style={{ padding: '4rem', backgroundColor: 'var(--bg-surface)' }}>
        ...
        {/* Stage 2 */}
        <div className="stage-row" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', borderBottom: '1px solid var(--border-light)' }}>
          <div className="stage-cell" style={{ padding: '4rem', backgroundColor: 'var(--bg-surface)', borderRight: '1px solid var(--border-light)' }}>
            <CodeBlock code={aiOutput} language="json" />
          </div>
          <div className="stage-cell" style={{ padding: '4rem' }}>
